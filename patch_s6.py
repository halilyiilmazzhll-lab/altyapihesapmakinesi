...
target = r'0 -> LazyColumn\(Modifier\.weight\(1f\), contentPadding = PaddingValues\(12\.dp\), verticalArrangement = Arrangement\.spacedBy\(8\.dp\)\) \{\s*items\(StakeoutField\.entries\) \{ field ->'
...
with codecs.open(path, 'w', 'utf-8') as f:
    f.write(content)
print("Regex updated StakeoutScreen")